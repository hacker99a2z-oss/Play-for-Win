...
const Fighting = ({ onPlayAd }) => {
  ...
  return (
    ...
    <div className="w-full flex flex-col justify-between py-2 pb-10">
      ...
      {/* ২. ইঁদুরের বড় কার্ড এবং পাওয়ার পজিশনিং */}
        ...
        {mice.map((mouse) => (
          ...
          <div key={mouse.id} className="flex flex-col gap-2 items-center">
            ...
            <div className="w-full relative inline-block transform scale-105 origin-center">
              ...
              {/* পাওয়ারের সংখ্যাটি নিখুঁতভাবে বসানোর জন্য পজিশন */}
      ...
      {/* ৩. FIGHT! বাটন (নেভিগেশনের উপরে রাখার জন্য Margin অ্যাডজাস্ট করা হয়েছে) */}
