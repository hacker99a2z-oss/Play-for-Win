  ...
  return (
    <div className="flex flex-col items-center justify-between min-h-[calc(100vh-140px)] p-6 text-white text-center">
      ...
      <div className="my-auto flex flex-col items-center gap-6">
        <button 
          onClick={onPlayAd}
          className="w-44 h-44 rounded-full bg-gradient-to-b from-yellow-400 to-amber-600 text-slate-950 font-black text-2xl flex flex-col items-center justify-center gap-2 shadow-2xl active:scale-95 transition-transform"
        >
